...
import com.aceplussolutions.mvp.presenterImpl.UpComingMovieListPresenterImpl;
 ...
 */
public class UpComingMovieListFragment extends Fragment implements UpComingMovieListContract.UpComingMovieListView,MovieListDelegate{
    ...
    UpComingMovieListContract.UpComingMovieListPresenter upComingMovieListPresenter;


    public UpComingMovieListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_up_coming_movie_list, container, false);

        ButterKnife.bind(this, view);

        upComingMovieListPresenter = new UpComingMovieListPresenterImpl(this);


        upComingMovieListPresenter.getUpComingMovieList();
